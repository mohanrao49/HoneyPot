...
def save_session(sid, data):
    ...
    # Render free tier has a read-only filesystem unless a disk is attached.
    # We catch any IOErrors to prevent the request from failing.
    try:
        ...
        # Gracefully handle read-only filesystem
        print(f"Warning: Could not save session to disk (likely read-only filesystem): {e}")
